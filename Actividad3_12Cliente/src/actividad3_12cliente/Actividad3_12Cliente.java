...
public class Actividad3_12Cliente extends JFrame implements ActionListener, Runnable{
    ...
    // constructor
    public Actividad3_12Cliente(Socket s, String nombre) {
	...
	if (nombre.trim().length() == 0) {
		...
		return;
         ...
         try {
			...
			Actividad3_12Cliente cliente = new Actividad3_12Cliente (s, nombre);
